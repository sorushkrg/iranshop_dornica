...
<!-- Mirrored from amirtttk.ir/single-product.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Dec 2024 19:47:40 GMT -->

<head>
  <?php require_once "masterPage/head.php" ?>

  <title><?= testSecurity($setting["site_name"])?>-محصولات</title>
  <!-- PRODUCT SLIDER CSS -->
  <link rel="stylesheet" href="assets/css/swiper-bundle.min.css" />
  <link rel="stylesheet" href="assets/css/style.product.slider.css" />

  <!-- TOAST -->
  <link rel="stylesheet" href="attachment/css/toastify.css">
</head>
      ...
      <div class="p-3 w-11/12 mx-auto rounded-2xl">
          ...
          <div class="w-full lg:w-1/3">
            <div>
              <span class="flex items-center pr-20 pb-2">
                <img onclick="showAlertAddTocomparison()" class="w-6 ml-2 cursor-pointer" src="attachment/image/comparison.png" alt="" title="مقایسه">
                <svg
            ...
            <div>
              <div class="max-w-[300px] mx-auto">
                <img class="mySlides rounded-xl md:rounded-3xl" src="attachment/image/productSlider/1.jpg" style="width:100%">
                <img class="mySlides rounded-xl md:rounded-3xl" src="attachment/image/productSlider/2.jpg" style="width:100%;display:none">
                <img class="mySlides rounded-xl md:rounded-3xl" src="attachment/image/productSlider/3.jpg" style="width:100%;display:none">
                <img class="mySlides rounded-xl md:rounded-3xl" src="attachment/image/productSlider/4.jpg" style="width:100%;display:none">
              </div>
              <div class="flex justify-around gap-x-4 mt-3">
                <div class="max-w-[80px]">
                  <img class="rounded-xl opacity-70 hover:opacity-100 transition" src="attachment/image/productSlider/1.jpg" onclick="currentDiv(1)">
                </div>
                <div class="max-w-[80px]">
                  <img class="rounded-xl opacity-70 hover:opacity-100 transition" src="attachment/image/productSlider/2.jpg" onclick="currentDiv(2)">
                </div>
                <div class="max-w-[80px]">
                  <img class="rounded-xl opacity-70 hover:opacity-100 transition" src="attachment/image/productSlider/3.jpg" onclick="currentDiv(3)">
                </div>
                <div class="max-w-[80px]">
                  <img class="rounded-xl opacity-70 hover:opacity-100 transition" src="attachment/image/productSlider/4.jpg" onclick="currentDiv(4)">
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="md:w-2/5 mt-5 md:mt-0">
                <div class="pb-5 rounded-2xl shadow-xl border">
                      ...
                      <div class="flex text-sm sm:text-sm items-center justify-center lg:justify-start">
                        <div class="flex items-center justify-center select-none">
                          <div class="quantity flex items-center">
                            <input class="w-12 h-7 mx-2 text-center border focus:outline-none rounded-lg" type="number" min="1" step="1" value="1" readonly>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <span class="flex justify-center items-center opacity-90">
                    <button class="px-7 py-2 text-center text-white bg-red-500 align-middle border-0 rounded-lg shadow-md text-sm">افزودن به سبد خرید</button>
                  </span>
                </div>
              </div>
            </div>
        ...
        <div class="flex justify-around my-5">
          <div class="flex flex-col items-center justify-center">
            <div>
              <img src="attachment/image/services/cash-on-delivery.svg" alt="">
            </div>
          ...
          <div class="flex flex-col items-center justify-center">
            <div>
              <img src="attachment/image/services/days-return.svg" alt="">
            </div>
            <div class="opacity-70 text-xs">
              قابل برگشت
            </div>
          ...
          <div class="flex flex-col items-center justify-center">
            <div>
              <img src="attachment/image/services/express-delivery.svg" alt="">
            </div>
            <div class="opacity-70 text-xs">
              ارسال سریع
            </div>
          ...
          <div class="flex flex-col items-center justify-center">
            <div>
              <img src="attachment/image/services/original-products.svg" alt="">
            </div>
            <div class="opacity-70 text-xs">
              ضمانت کالا
            </div>
              ...
              <div class="flex flex-col py-4 px-4 mx-auto my-6 max-w-7xl rounded-2xl bg-white">
                ...
                <div class="bg-gray-50 rounded-xl px-3 sm:px-5 py-3 my-2">
                  <div class="flex flex-col items-stat gap-y-2">
                    ...
                    <span class="text-green-400 bg-green-100 px-1 w-24 rounded-md text-sm text-center">
                      پیشنهاد شده
                    </span>
                  </div>
                  <div>
              ...
              <div class="card-wrapper swiper-wrapper py-4">
                <span class="card swiper-slide my-2 p-2 md:p-3 ">
                  <div class="image-box mb-6 ">
                    <a href="#">
                      <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="attachment/image/productSlider/1.jpg" alt="" />
                    </a>
                  </div>
                ...
                <span class="card swiper-slide my-2 p-2 md:p-3 ">
                  <div class="image-box mb-6 ">
                    <a href="#">
                      <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="attachment/image/productSlider/2.jpg" alt="" />
                    </a>
                  </div>
                  <div class="space-y-3 text-center">
                    <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
                ...
                <span class="card swiper-slide my-2 p-2 md:p-3 ">
                  <div class="image-box mb-6 ">
                    <a href="#">
                      <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="attachment/image/productSlider/3.jpg" alt="" />
                    </a>
                  </div>
                  <div class="space-y-3 text-center">
                    <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
                ...
                <span class="card swiper-slide my-2 p-2 md:p-3 ">
                  <div class="image-box mb-6 ">
                    <a href="#">
                      <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="attachment/image/productSlider/4.jpg" alt="" />
                    </a>
                  </div>
                  <div class="space-y-3 text-center">
                    <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
                ...
                <span class="card swiper-slide my-2 p-2 md:p-3 ">
                  <div class="image-box mb-6 ">
                    <a href="#">
                      <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="attachment/image/productSlider/5.jpg" alt="" />
                    </a>
                  </div>
                  <div class="space-y-3 text-center">
                    <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
                ...
                <span class="card swiper-slide my-2 p-2 md:p-3 ">
                  <div class="image-box mb-6 ">
                    <a href="#">
                      <img class="hover:scale-105 transition rounded-3xl w-full mx-auto" src="attachment/image/productSlider/6.jpg" alt="" />
                    </a>
                  </div>
                  <div class="space-y-3 text-center">
                    <span class="text-sm opacity-80 mb-2 h-8 md:h-10">
...
<script src="assets/js/showImageSingleProduct.js"></script>
<!-- TABS -->
<link rel="stylesheet" href="../unpkg.com/%40themesberg/flowbite%401.2.0/dist/flowbite.min.css" />
<script src="../unpkg.com/%40themesberg/flowbite%401.2.0/dist/flowbite.bundle.js"></script>
<!-- INPUTS ADD NUMBER -->
<script src="assets/js/jquery.min.js"></script>
<script src="assets/js/main.js"></script>

<!-- Mirrored from amirtttk.ir/single-product.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Dec 2024 19:47:43 GMT -->

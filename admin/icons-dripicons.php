...
<!-- Mirrored from theme-script.ir/templates/lexa/Lexa-RTL/RTL-lexa-teal/icons-dripicons.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Dec 2024 17:20:00 GMT -->
<head>

    <meta charset="utf-8" />
    <title>دور فین | لکسا - قالب مدیریت و داشبورد</title>
                    ...
                    <div class="col-sm-6">
                        <div class="page-title-box">
                            ...
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">دریپیکن ها</li>
                            </ol>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc">استفاده کنید <code>&lt;i

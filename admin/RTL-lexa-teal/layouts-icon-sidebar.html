...
<!-- Mirrored from theme-script.ir/templates/lexa/Lexa-RTL/RTL-lexa-teal/layouts-icon-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Dec 2024 17:20:03 GMT -->
<head>

    <meta charset="utf-8" />
    <title>نوار کناری نماد | لکسا - قالب مدیریت و داشبورد</title>
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li><a href="icons-dripicons.html">دریپیکن هاs</a></li>
                    ...
                    <div class="col-sm-6">
                        <div class="page-title-box">
                            ...
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">نماد نوار کناری</li>
                            </ol>
                        </div>
                    </div>
                    <div class="col-sm-6">

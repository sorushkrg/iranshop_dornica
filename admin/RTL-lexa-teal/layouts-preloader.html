...
<!-- Mirrored from theme-script.ir/templates/lexa/Lexa-RTL/RTL-lexa-teal/layouts-preloader.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Dec 2024 17:20:03 GMT -->
<head>

    <meta charset="utf-8" />
    <title>پیش لودر | لکسا - قالب مدیریت و داشبورد</title>
                    ...
                    <div class="col-sm-6">
                        <div class="page-title-box">
                            ...
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">عمودی</a></li>
                                <li class="breadcrumb-item active">پیش لودر</li>
                            </ol>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="card mini-stat bg-primary">
                            <div class="card-body mini-stat-img">
                                ...
                                <div class="text-white">
                                    ...
                                    <h2 class="mb-4 text-white">46,782 تومان </h2>
                        ...
                        <div class="card mini-stat bg-primary">
                            <div class="card-body mini-stat-img">
                                ...
                                <div class="text-white">
                                    ...
                                    <h2 class="mb-4 text-white">15.9 تومان </h2>
                                ...
                                <div class="inbox-wid">
                                    ...
                                    <a href="#" class="text-dark">
                                        <div class="inbox-item">
                                            ...
                                            <p class="inbox-item-text text-muted mb-0">سلام! آنجا من در دسترس هستم ...</p>
                                            <p class="inbox-item-date text-muted">11:47 صبح</p>
                                        </div>
                                    </a>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div>
                                            ...
                                            <a href="#" class="text-primary">بیشتر بدانید <i class="mdi mdi-chevron-double-left"></i></a>
                                        </div>
                                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table align-middle table-centered table-vertical table-nowrap mb-1">
                                        ...
                                        <tr>
                                            <td>#85214796</td>
                                            <td>
                                                <img src="assets/images/users/user-5.jpg" alt="user-image" class="avatar-xs me-2 rounded-circle" /> بلندگو بوپلی
                                            </td>
                                            <td><span class="badge rounded-pill bg-success">تحویل داده شده</span></td>
                                            <td>
                                                584 تومان
...
<!-- Mirrored from theme-script.ir/templates/lexa/Lexa-RTL/RTL-lexa-teal/layouts-preloader.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Dec 2024 17:20:04 GMT -->
</html>
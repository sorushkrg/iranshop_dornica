...
<!-- Mirrored from theme-script.ir/templates/lexa/Lexa-RTL/RTL-lexa-teal/ui-sweet-alert.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Dec 2024 17:19:41 GMT -->
<head>

    <meta charset="utf-8" />
    <title>شیرین - هشدار | لکسا - قالب مدیریت و داشبورد</title>
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li><a href="email-read.html">ایمیل خواندن</a></li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li><a href="ui-dropdowns.html">کشویی</a></li>
                            <li><a href="ui-grid.html">توری</a></li>
                            <li><a href="ui-images.html">تصاویر</a></li>
                            <li><a href="ui-lightbox.html">جعبه نور</a></li>
                            <li><a href="ui-modals.html">مدال ها</a></li>
                            <li><a href="ui-offcanvas.html">خارج از بوم</a></li>
                            <li><a href="ui-pagination.html">صفحه بندی</a></li>
                            <li><a href="ui-popover-tooltips.html">پاپاور , نکات ابزار</a></li>
                            <li><a href="ui-rangeslider.html">لغزنده برد</a></li>
                            <li><a href="ui-session-timeout.html">پایان جلسه</a></li>
                            <li><a href="ui-progressbars.html">نوارهای پیشرفت</a></li>
                            <li><a href="ui-sweet-alert.html">هشدار شیرین</a></li>
                            <li><a href="ui-tabs-accordions.html"> زبانه ها ,   آکاردئون </a></li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li><a href="form-editors.html">ویراستاران فرم</a></li>
                            <li><a href="form-uploads.html">آپلود فایل فرم</a></li>
                            <li><a href="form-xeditable.html">فرم قابل ویرایش</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li><a href="charts-chartjs.html">نمودار جی اس</a></li>
                            <li><a href="charts-flot.html">نمودار فلوت</a></li>
                            <li><a href="charts-c3.html">نمودار C3</a></li>
                            <li><a href="charts-other.html">نمودار دستگیره جی کوئری</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li><a href="icons-ion.html">آیکون های یون</a></li>
                            <li><a href="icons-fontawesome.html">فونت عالی</a></li>
                            <li><a href="icons-themify.html">آیکون های تمیفای</a></li>
                            <li><a href="icons-dripicons.html">دریپیکن ها</a></li>
                            <li><a href="icons-typicons.html">نمادهای تایپیکون</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-title">موارد اضافی</li>

                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            <i class="mdi mdi-responsive"></i>
                            <span> طرح بندی ها </span>
                        </a>
                        <ul class="sub-menu" aria-expanded="true">
                            <li>
                                <a href="javascript: void(0);" class="has-arrow">عمودی</a>
                                <ul class="sub-menu" aria-expanded="true">
                                    <li><a href="layouts-light-sidebar.html">نوار کناری نور</a></li>
                                    <li><a href="layouts-compact-sidebar.html">نوار کناری فشرده</a></li>
                                    <li><a href="layouts-icon-sidebar.html">نماد نوار کناری</a></li>
                                    <li><a href="layouts-boxed.html">طرح بندی جعبه ای</a></li>
                                    <li><a href="layouts-preloader.html">پیش بارگذاری</a></li>
                                    <li><a href="layouts-colored-sidebar.html">نوار کناری رنگی</a></li>
                                </ul>
                            </li>

                            <li>
                                <a href="javascript: void(0);" class="has-arrow">افقی</a>
                                <ul class="sub-menu" aria-expanded="true">
                                    <li><a href="layouts-horizontal.html">افقی</a></li>
                                    <li><a href="layouts-hori-topbar-dark.html">تاپبار تاریک</a></li>
                                    <li><a href="layouts-hori-preloader.html">پیش بارگذاری</a></li>
                                    <li><a href="layouts-hori-boxed-width.html">طرح بندی جعبه ای</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="pages-login.html">وارد شدن</a></li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li><a href="pages-directory.html">فهرست راهنما</a></li>
                            <li><a href="pages-blank.html">صفحه خالی</a></li>
                            <li><a href="pages-404.html">خطا 404</a></li>
                            <li><a href="pages-500.html">خطا 500</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="true">
                            <li><a href="javascript: void(0);">مرحله 1.1</a></li>
                            <li><a href="javascript: void(0);" class="has-arrow">مرحله 1.2</a>
                                <ul class="sub-menu" aria-expanded="true">
                                    <li><a href="javascript: void(0);">مرحله 2.1</a></li>
                                    <li><a href="javascript: void(0);">مرحله 2.2</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
    ...
    <div class="main-content">
                    ...
                    <div class="col-sm-6">
                        <div class="page-title-box">
                            ...
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">هشدار شیرین</li>
                            </ol>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card ">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc">یک جایگزین زیبا، پاسخگو، قابل تنظیم و در دسترس (WAI-ARIA) برای جعبه های بازشو جاوا اسکریپت. وابستگی صفر
                                </p>

                                <div class="row text-center">
                                    <div class="col-xl-3 col-md-4 col-sm-6 mb-4">
                                        <p class="text-muted">یک پیام اساسی</p>
                                        <button type="button" class="btn btn-primary waves-effect waves-light" id="sa-basic">مرا کلیک کن</button>
                                    </div>
                                    <div class="col-xl-3 col-md-4 col-sm-6 mb-4">
                                        <p class="text-muted">عنوانی با متن زیر</p>
                                        <button type="button" class="btn btn-primary waves-effect waves-light" id="sa-title">مرا کلیک کن</button>
                                    </div>
                                    <div class="col-xl-3 col-md-4 col-sm-6 mb-4">
                                        <p class="text-muted">یک پیام موفقیت!</p>
                                        <button type="button" class="btn btn-primary waves-effect waves-light" id="sa-success">مرا کلیک کن</button>
                                    </div>
                                    <div class="col-xl-3 col-md-4 col-sm-6 mb-4">
                                        <p class="text-muted">یک پیام هشدار با یک تابع متصل به دکمه "تأیید"...</p>
                                        <button type="button" class="btn btn-primary waves-effect waves-light" id="sa-warning">مرا کلیک کن</button>
                                    </div>

                                    <div class="col-xl-3 col-md-4 col-sm-6 mb-4">
                                        <p class="text-muted">برای  با ارسال یک پارامتر، می توانید چیز دیگری را برای "لغو" اجرا کنید.</p>
                                        <button type="button" class="btn btn-primary waves-effect waves-light" id="sa-params">مرا کلیک کن</button>
                                    </div>
                                    <div class="col-xl-3 col-md-4 col-sm-6 mb-4">
                                        <p class="text-muted">پیامی با هدر تصویر سفارشی</p>
                                        <button type="button" class="btn btn-primary waves-effect waves-light" id="sa-image">مرا کلیک کن</button>
                                    </div>
                                    <div class="col-xl-3 col-md-4 col-sm-6 mb-4">
                                        <p class="text-muted">پیامی با تایمر بسته خودکار</p>
                                        <button type="button" class="btn btn-primary waves-effect waves-light" id="sa-close">مرا کلیک کن</button>
                                    </div>
                                    <div class="col-xl-3 col-md-4 col-sm-6 mb-4">
                                        <p class="text-muted">توضیحات و دکمه های HTML سفارشی</p>
                                        <button type="button" class="btn btn-primary waves-effect waves-light" id="custom-html-alert">مرا کلیک کن</button>
                                    </div>
                                    <div class="col-xl-3 col-md-4 col-sm-6 mb-4">
                                        <p class="text-muted">پیامی با عرض، بالشتک و پس‌زمینه سفارشی</p>
                                        <button type="button" class="btn btn-primary waves-effect waves-light" id="custom-padding-width-alert">مرا کلیک کن</button>
                                    </div>
                                    <div class="col-xl-3 col-md-4 col-sm-6 mb-4">
                                        <p class="text-muted">نمونه درخواست آژاکس</p>
                                        <button type="button" class="btn btn-primary waves-effect waves-light" id="ajax-alert">مرا کلیک کن</button>
                                    </div>
                                    <div class="col-xl-3 col-md-4 col-sm-6 mb-4">
                                        <p class="text-muted">مثال زنجیر زدن (صف).</p>
                                        <button type="button" class="btn btn-primary waves-effect waves-light" id="chaining-alert">مرا کلیک کن</button>
                                    </div>
                                    <div class="col-xl-3 col-md-4 col-sm-6 mb-4">
                                        <p class="text-muted">نمونه صف پویا</p>
                                        <button type="button" class="btn btn-primary waves-effect waves-light" id="dynamic-alert">مرا کلیک کن</button>
                                    </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        © <script>document.write(new Date().getFullYear())</script> لکسا <span class="d-none d-sm-inline-block">   - ساخته شده با <i class="mdi mdi-heart text-danger"></i> توسط تم دیزاین</span>
                    </div>
                </div>
            </div>
        </footer>
...
<div class="right-bar">
    <div data-simplebar class="h-100">
        ...
        <!-- Settings -->
        <hr class="mt-0" />
        <h6 class="text-center mb-0">طرح بندی ها را انتخاب کنید</h6>
        ...
        <div class="p-4">
            ...
            <div class="form-check form-switch mb-3">
                ...
                <label class="form-check-label" for="light-mode-switch">حالت نور</label>
            </div>
            ...
            <div class="form-check form-switch mb-3">
                ...
                <label class="form-check-label" for="dark-mode-switch">حالت تاریک</label>
            </div>
            ...
            <div class="form-check form-switch mb-5">
                ...
                <label class="form-check-label" for="rtl-mode-switch">حالت LTR</label>
            </div>
...
<!-- Mirrored from theme-script.ir/templates/lexa/Lexa-RTL/RTL-lexa-teal/ui-sweet-alert.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Dec 2024 17:19:42 GMT -->
</html>
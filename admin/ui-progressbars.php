...
<!-- Mirrored from theme-script.ir/templates/lexa/Lexa-RTL/RTL-lexa-teal/ui-progressbars.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Dec 2024 17:19:41 GMT -->
<head>

    <meta charset="utf-8" />
    <title>میله های پیشرفت | لکسا - قالب مدیریت و داشبورد</title>
                    ...
                    <div class="col-sm-6">
                        <div class="page-title-box">
                            ...
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">نوارهای پیشرفت</li>
                            </ol>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">نمونه های پیش فرض</h4>
                                <p class="card-title-desc">کامپوننت های پیش رفتن با دو عنصر HTML، مقداری CSS برای تنظیم عرض و چند ویژگی ساخته شده اند.</p>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">پس زمینه ها</h4>
                                <p class="card-title-desc">از کلاس های ابزار پس زمینه برای تغییر ظاهر نوارهای پیشرفت فردی استفاده کنید.</p>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">نمونه برچسب ها</h4>
                                <p class="card-title-desc">با قرار دادن متن در نوار پیشرفت، برچسب‌ها را به نوارهای پیشرفت خود اضافه کنید <code class="highlighter-rouge">.progress-bar</code>.</p>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">میله های متعدد</h4>
                                <p class="card-title-desc">در صورت نیاز، چندین نوار پیشرفت را در یک جزء پیشرفت قرار دهید.</p>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">ارتفاع</h4>
                                <p class="card-title-desc">ما فقط a را تنظیم کردیم <code class="highlighter-rouge">height</code> ارزش بر روی <code class="highlighter-rouge">.progress-bar</code>, بنابراین اگر آن مقدار خارجی را تغییر دهید <code class="highlighter-rouge">.progress</code>  به طور خودکار بر این اساس اندازه تغییر می کند.</p>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">راه راه های متحرک</h4>
                                <p class="card-title-desc">گرادیان راه راه نیز می تواند متحرک شود. اضافه کردن <code class="highlighter-rouge">.progress-bar-animated</code> to <code class="highlighter-rouge">.progress-bar</code> برای متحرک سازی راه راه ها از راست به چپ از طریق انیمیشن های CSS3.</p>
                    ...
                    <div class="col-xl-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">راه راه</h4>
                                <p class="card-title-desc">اضافه کردن <code class="highlighter-rouge">.progress-bar-striped</code> به هر که <code class="highlighter-rouge">.progress-bar</code> برای اعمال یک نوار از طریق گرادیان CSS روی رنگ پس‌زمینه نوار پیشرفت.</p>

...
<!-- Mirrored from theme-script.ir/templates/lexa/Lexa-RTL/RTL-lexa-teal/icons-themify.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Dec 2024 17:19:59 GMT -->
<head>

    <meta charset="utf-8" />
    <title>نمادهای تمیفای | لکسا - قالب مدیریت و داشبورد</title>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="page-title-box">
                            <h4>نمادهای تمیفای</h4>
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">لکسا</a></li>
                                <li class="breadcrumb-item"><a href="javascript: void(0);">نمادها</a></li>
                                <li class="breadcrumb-item active">نمادهای تمیفای</li>
                            </ol>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-title-desc">
                                    استفاده کنید از<code>&lt;i class="ti-arrow-up"&gt;&lt;/i&gt;</code>.
                                </p>
                                ...
                                <h4 class="card-title mb-4 mt-5">نمادهای برنامه وب</h4>
                                ...
                                <h4 class="card-title mt-5 mb-4">آیکون های کنترل</h4>
                                ...
                                <h4 class="card-title mt-5 mb-4">ویرایشگر متن</h4>
                                ...
                                <h4 class="card-title mt-5 mb-4">چیدمان نمادها</h4>
                                ...
                                <h4 class="card-title mt-5 mb-4">نمادهای برند</h4>
...
<!-- Mirrored from theme-script.ir/templates/lexa/Lexa-RTL/RTL-lexa-teal/icons-themify.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Dec 2024 17:20:00 GMT -->
</html>
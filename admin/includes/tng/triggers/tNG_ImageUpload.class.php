...
//		$this->dynamicFolder=$this->dynamicFolder;
...
//				$KSc['FTP']   = new KSc_Ftp;
//			$KSc['FTP']->KSf_Connect();
//			$this->dynamicFolder="ftp://".$KSc['FTP']->username.":".$KSc['FTP']->userpass."@".$KSc['FTP']->server."/".$this->folder."/";
//		}
//	var_dump($this->dynamicFolder);die();
		...
		$image->resize($this->dynamicFolder.$this->uploadedFileName, $this->dynamicFolder, $this->uploadedFileName, $this->resizeWidth, $this->resizeHeight, $this->resizeProportional,$this->uploadType);
		if ($image->hasError()) {

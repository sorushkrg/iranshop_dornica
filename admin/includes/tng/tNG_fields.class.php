...
class tNG_fields extends tNG
{
	 ...
	 * @access public
	 */
	function addColumn($colName, $type, $method, $reference, $tetype = '')
	{
	...
	function getFakeRecordset($fakeArr)
	{
		...
		new tNG_log('tNG' . $this->transactionType, "getFakeRecordset");
	...
	function getRecordset()
	{
		...
		new tNG_log('tNG' . $this->transactionType, "getRecordset");
	...
	{
		new tNG_log('tNG' . $this->transactionType, "getFakeRsArr");
		$localRs = $this->getLocalRecordset();
		if (is_object($localRs)) {
	...
	{
		new tNG_log('tNG' . $this->transactionType, "afterUpdateField", "$fieldName, $fieldValue");
	...
	function saveData()
	{
		new tNG_log('tNG' . $this->transactionType, "saveData");

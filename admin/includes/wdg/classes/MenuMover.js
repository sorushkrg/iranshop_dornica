...
MXW_MenuMover.prototype.render = function() {
	...
	tmp.innerHTML = '<table class="t-table" border="0" cellspacing="0" cellpadding="0"><tr><td class="td1"></td><td><table class="menumover_icons_table" border="0" cellspacing="2" cellpadding="0"><tr><td class="icon1"></td><td class="icon2"></td></tr><tr><td class="icon3"></td><td class="icon4"></td></tr></table></td><td  class="td2"></td></tr></table>\r\n';

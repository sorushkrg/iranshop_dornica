...
<!-- Mirrored from amirtttk.ir/profile-comments.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Dec 2024 19:47:56 GMT -->

<head>
  <?php require_once "masterPage/head.php" ?>

  <title><?= testSecurity($setting["site_name"])?>-نظر های من</title>
</head>
      ...
      <div class="flex flex-col md:flex-row gap-5">
        <div class="md:w-4/12 lg:w-3/12 flex flex-col gap-y-5">
          ...
          <div class="border rounded-3xl shadow-lg flex flex-col justify-center items-center p-2 gap-y-2">
            ...
            <a href="profile-comments.html" class="text-sm opacity-80 w-full flex justify-end pr-5 flex-row-reverse items-center hover:text-red-600 transition hover:bg-gray-100 py-3 rounded-2xl bg-gray-200 text-red-600">
              نظرات من
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#474747" viewBox="0 0 256 256">
            ...
            <a href="profile-personal-info.html" class="text-sm opacity-80 w-full flex justify-end pr-5 flex-row-reverse items-center hover:text-red-600 transition hover:bg-gray-100 py-3 rounded-2xl">
              اطلاعات حساب
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#474747" viewBox="0 0 256 256">
          ...
          <table class="w-full text-sm text-left rtl:text-right text-gray-500">
            ...
            <tbody class="grid grid-cols-1 sm:grid-cols-2 md:contents gap-5">
              <tr class="bg-white hover:bg-gray-50 grid grid-cols-1 justify-items-center md:table-row border-x sm:border-x-0 sm:border-b">
                <td class="px-2 py-4">
                  <img src="attachment/image/productSlider/2.jpg" class="w-48 md:w-28 max-w-full max-h-full rounded-lg" alt="">
                </td>
                <td class="md:pr-6 py-4 text-xs opacity-90 text-gray-900">
                  ساعت اپل مدل a32s پلاس
                </td>
                <td class="px-3 py-4 max-w-md text-xs">
                  کیفیت بینظیر حتما پیشنهاد میکنم
                </td>
              ...
              <tr class="bg-white hover:bg-gray-50 grid grid-cols-1 justify-items-center md:table-row border-x sm:border-x-0 sm:border-b">
                <td class="px-2 py-4">
                  <img src="attachment/image/productSlider/3.jpg" class="w-48 md:w-28 max-w-full max-h-full rounded-lg" alt="">
                </td>
                <td class="md:pr-6 py-4 text-xs opacity-90 text-gray-900">
                  ریش تراش دایاک
                </td>
                ...
                <td class="px-6 py-4 text-sm opacity-90 text-red-500">
                  ردشده
                </td>
                <td class="px-3 py-4">
                  <a href="#" class=" text-red-600">حذف</a>
              ...
              <tr class="bg-white hover:bg-gray-50 grid grid-cols-1 justify-items-center md:table-row border-x sm:border-x-0 sm:border-b">
                <td class="px-2 py-4">
                  <img src="attachment/image/productSlider/6.jpg" class="w-48 md:w-28 max-w-full max-h-full rounded-lg" alt="">
                </td>
                <td class="md:pr-6 py-4 text-xs opacity-90 text-gray-900">
                  هنذفری بلوتوثی شیائومی
                </td>
                <td class="px-3 py-4 max-w-md text-xs">
                  خوبه کیفیتش؟ نویز داره؟و اینکه ارزش خرید داره یا نه ؟
                </td>
...
<!-- Mirrored from amirtttk.ir/profile-comments.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Dec 2024 19:47:57 GMT -->

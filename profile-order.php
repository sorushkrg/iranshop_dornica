...
<!-- Mirrored from amirtttk.ir/profile-order.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Dec 2024 19:47:40 GMT -->

<head>
  <?php require_once "masterPage/head.php" ?>

  <title><?= testSecurity($setting["site_name"])?>-سفارش های من</title>
</head>
      ...
      <div class="flex flex-col md:flex-row gap-5">
        <div class="md:w-4/12 lg:w-3/12 flex flex-col gap-y-5">
          ...
          <div class="border rounded-3xl shadow-lg flex flex-col justify-center items-center p-2 gap-y-2">
            ...
            <a href="profile-order.html" class="text-sm opacity-80 w-full flex justify-end pr-5 flex-row-reverse items-center hover:text-red-600 transition hover:bg-gray-100 py-3 rounded-2xl bg-gray-200 text-red-600">
              سفارش ها
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#474747" viewBox="0 0 256 256">
            ...
            <table class="w-full text-sm text-right text-gray-600">
              ...
              <tbody>
                <tr class="hover:bg-gray-100 transition text-xs border-b">
                  ...
                  <td class="px-6 py-4">
                    <a href="#" class="text-red-500 border-b border-red-400">مشاهده</a>
                  </td>
                </tr>
                <tr class="hover:bg-gray-100 transition text-xs border-b">
                  <th scope="row" class="px-6 py-4 font-medium">

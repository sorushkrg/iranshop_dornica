...
<!-- Mirrored from amirtttk.ir/profile-favorites.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Dec 2024 19:47:40 GMT -->

<head>
  <?php require_once "masterPage/head.php" ?>

  <title><?= testSecurity($setting["site_name"])?>-علاقه های من</title>
</head>
      ...
      <div class="flex flex-col md:flex-row gap-5">
        <div class="md:w-4/12 lg:w-3/12 flex flex-col gap-y-5">
          ...
          <div class="border rounded-3xl shadow-lg flex flex-col justify-center items-center p-2 gap-y-2">
            ...
            <a href="profile-favorites.html" class="text-sm opacity-80 w-full flex justify-end pr-5 flex-row-reverse items-center hover:text-red-600 transition hover:bg-gray-100 py-3 rounded-2xl bg-gray-200 text-red-600">
              علاقه مندی ها
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#474747" viewBox="0 0 256 256">
              ...
              <tbody class="grid grid-cols-1 sm:grid-cols-2 md:contents gap-5">
                <tr class="bg-white border-b hover:bg-gray-50 grid grid-cols-1 justify-items-center md:table-row">
                  ...
                  <td class="px-2 py-4">
                    ...
                    <a href="#" class="text-white bg-green-500 hover:bg-green-600 transition px-2 py-1 shadow-lg rounded-md mr-3">مشاهده</a>
                  </td>
                </tr>
                <tr class="bg-white border-b hover:bg-gray-50 grid grid-cols-1 justify-items-center md:table-row">
                  <td class="p-4">

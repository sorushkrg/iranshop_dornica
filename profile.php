...
<!-- Mirrored from amirtttk.ir/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Dec 2024 19:47:39 GMT -->

<head>
  <?php require_once "masterPage/head.php" ?>

  <title><?= testSecurity($setting["site_name"])?>-پروفایل</title>
</head>
      ...
      <div class="flex flex-col md:flex-row gap-5">
        <div class="md:w-4/12 lg:w-3/12 flex flex-col gap-y-5">
          ...
          <div class="border rounded-3xl shadow-lg flex flex-col justify-center items-center p-2 gap-y-2">
            <a href="profile.html" class="text-sm opacity-80 w-full flex justify-end pr-5 flex-row-reverse items-center hover:text-red-600 transition hover:bg-gray-100 py-3 rounded-2xl bg-gray-200 text-red-600">
              پروفایل
        ...
        <div class="md:w-8/12 lg:w-9/12">
          <div class="border rounded-3xl shadow-lg flex flex-col p-5 gap-y-5">
            ...
            <span class="opacity-90">
              <button class="px-7 py-2 text-center text-white bg-red-500 align-middle border-0 rounded-lg shadow-md text-sm">ویرایش اطلاعات</button>
            </span>
          </div>
        </div>
      </div>
...
<!-- Mirrored from amirtttk.ir/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Dec 2024 19:47:40 GMT -->

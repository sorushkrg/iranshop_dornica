...
<!-- Mirrored from amirtttk.ir/search.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Dec 2024 19:47:56 GMT -->

<head>
  <?php require_once "masterPage/head.php" ?>

  <title><?= testSecurity($setting["site_name"])?>-جستجو</title>
</head>
            ...
            <div>
              ...
              <div class="space-y-1">
                <div class="flex items-center rounded-lg hover:bg-gray-100 opacity-80">
                  ...
                  <label for="checkbox-item-1" class="w-full text-xs text-gray-900 rounded pr-1 py-2">تکنولوژی</label>
                </div>
                <div class="flex items-center rounded-lg hover:bg-gray-100 opacity-80">
                  <input id="checkbox-item-2" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 mr-3">
                  <label for="checkbox-item-2" class="w-full text-xs text-gray-900 rounded pr-1 py-2">سوپرمارکت</label>
                </div>
                <div class="flex items-center rounded-lg hover:bg-gray-100 opacity-80">
                  <input id="checkbox-item-3" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 mr-3">
                  <label for="checkbox-item-3" class="w-full text-xs text-gray-900 rounded pr-1 py-2">مد و پوشاک</label>
                </div>
                <div class="flex items-center rounded-lg hover:bg-gray-100 opacity-80">
                  <input id="checkbox-item-4" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 mr-3">
                  <label for="checkbox-item-4" class="w-full text-xs text-gray-900 rounded pr-1 py-2">آرایشی و بهداشتی</label>
                </div>
                <div class="flex items-center rounded-lg hover:bg-gray-100 opacity-80">
                  <input id="checkbox-item-5" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 mr-3">
                  <label for="checkbox-item-5" class="w-full text-xs text-gray-900 rounded pr-1 py-2">لوازم خانگی</label>
                </div>
                <div class="flex items-center rounded-lg hover:bg-gray-100 opacity-80">
                  <input id="checkbox-item-6" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 mr-3">
                  <label for="checkbox-item-6" class="w-full text-xs text-gray-900 rounded pr-1 py-2">لوازم چوبی</label>
                </div>
                <div class="flex items-center rounded-lg hover:bg-gray-100 opacity-80">
                  <input id="checkbox-item-7" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 mr-3">
                  <label for="checkbox-item-7" class="w-full text-xs text-gray-900 rounded pr-1 py-2">ابزارآلات</label>
                </div>
                <div class="flex items-center rounded-lg hover:bg-gray-100 opacity-80">
                  <input id="checkbox-item-8" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 mr-3">
                  <label for="checkbox-item-8" class="w-full text-xs text-gray-900 rounded pr-1 py-2">موتور و لوازم جانبی</label>
                </div>
              </div>
            </div>
          </div>
